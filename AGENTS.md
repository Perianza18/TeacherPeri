# Working on TeacherPeri

This repository contains legacy Axioma code being migrated incrementally into TeacherPeri.

- Read [docs/PRODUCT.md](docs/PRODUCT.md) and [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) before product-level architectural changes. Use [docs/MIGRATION.md](docs/MIGRATION.md) for legacy context and [docs/ROADMAP.md](docs/ROADMAP.md) for phase boundaries.
