...
5. Ensure Codex/other agents read the current docs before architectural work.

This file exists so that TeacherPeri does not depend on the memory of any one chat, coding agent, or person.
